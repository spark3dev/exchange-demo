...
public class ResponseSignatureValue implements java.io.Serializable
{
   ...
   public ResponseSignatureValue(java.util.List<java.lang.String> content)
   {
      this.content = content;
   }

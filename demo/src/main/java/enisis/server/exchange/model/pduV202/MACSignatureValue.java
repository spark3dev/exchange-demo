...
public class MACSignatureValue implements java.io.Serializable
{
   ...
   public MACSignatureValue(java.util.List<java.lang.String> content)
   {
      this.content = content;
   }

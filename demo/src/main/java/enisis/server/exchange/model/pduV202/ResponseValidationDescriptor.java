...
public class ResponseValidationDescriptor implements java.io.Serializable
{
   ...
   public ResponseValidationDescriptor()
   {
   }
   ...
   public ResponseValidationDescriptor(java.util.List<java.lang.String> content)
   {
      this.content = content;
   }
